...
|-----------|-----------|-----------------|
| Value Deviation | [REDACTED] | Transaction value > 2.5σ from historical mean |
| Contract Diversity | [REDACTED] | Interacting with unknown/new contracts |
| Velocity | [REDACTED] | Actions faster than 50% of normal interval |
| Function Pattern | [REDACTED] | Calling unusual functions for this agent |
| Time-of-Day | [REDACTED] | Activity outside the agent's normal hours |
