...
| Dimension | What It Detects | Score Weight |
|-----------|----------------|-------------|
| Value Deviation | Transaction value > 2.5σ from historical mean | +25 |
| Contract Diversity | First interaction with unknown contract | +20 |
| Velocity | Action submitted in < 50% of expected interval | +15 |
...
sequenceDiagram
    ...
    Note over BA: Anomaly score: 95/100<br/>+25 (value 40σ from mean)<br/>+20 (unknown contract)<br/>+30 (unusual function)<br/>+10 (time anomaly)<br/>+10 (velocity spike)
