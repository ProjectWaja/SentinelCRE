...
export const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Sequential Probing fires (+35) — 6 monotonically increasing values',
      'Layer 2: Value Deviation fires (+12) — 5.2x above moving average',
      'Layer 2: Cumulative Drift fires (+20) — 2,500% above origin baseline',
      'Behavioral Risk Score: 67/100 — exceeds threshold (50)',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Time-of-Day fires (+30) — "EMERGENCY" + "immediately" social engineering pattern',
      'Layer 2: Value Deviation fires (+25) — "transfer all" fund extraction language detected',
      'Behavioral Risk Score: 55/100 — exceeds threshold (50)',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Velocity fires (+50) — 16 rapid transactions, 5x above baseline interval',
      'Behavioral Risk Score: 50/100 — exceeds threshold (50)',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Cumulative Drift fires (+20) — 0.8 ETH is 700% above origin baseline 0.1 ETH',
      'Layer 2: Velocity fires (+25) — 12 rapid transactions in succession',
      'Layer 2: Value Deviation fires (+12) — 2.5x above moving average',
      'Behavioral Risk Score: 57/100 — slow baseline poisoning detected and blocked',
    ],
    proposal: {
      agentId: DEMO_AGENTS[0].id,
      targetContract: APPROVED_DEX,
...
export const INCIDENT_SCENARIOS: DemoScenario[] = [
  {
    ...
    steps: [
      ...
      'Layer 1: PolicyLib passes — value, target, function all within bounds',
      'Layer 2: Time-of-Day fires (+30) — "EMERGENCY" + "immediately" social engineering',
      'Layer 2: Value Deviation fires (+25) — "transfer all" fund extraction language',
      'Behavioral Risk Score: 55/100 — this is exactly what happened to AIXBT on Base',
    ],
    proposal: {
      agentId: DEMO_AGENTS[0].id,
      targetContract: APPROVED_DEX,
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Value Deviation fires (+25) — unprecedented amount',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Sequential Probing fires (+35) — 6 monotonically increasing values',
      'Layer 2: Value Deviation fires (+12) — 5.2x above moving average',
      'Layer 2: Cumulative Drift fires (+20) — 0.8 ETH is 2,500% above origin baseline',
      'Behavioral Risk Score: 67/100 — caught probing before reaching actual threshold',
    ],
    proposal: {
      agentId: DEMO_AGENTS[0].id,
      targetContract: APPROVED_DEX,
