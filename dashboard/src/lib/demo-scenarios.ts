...
export const DEFAULT_POLICY: PolicyOverrides = {
  ...
  anomalyThreshold: 0, // Production threshold is proprietary
...
export const DEMO_SCENARIOS: DemoScenario[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Sequential Probing fires — monotonically increasing values detected',
      'Layer 2: Value Deviation fires — significantly above moving average',
      'Layer 2: Cumulative Drift fires — far above origin baseline',
      'Behavioral risk score exceeds threshold — multiple dimensions triggered',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Time-of-Day anomaly fires — activity outside normal operating hours',
      'Layer 2: Social engineering patterns detected in action description',
      'Behavioral risk score exceeds threshold — multiple dimensions triggered',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Velocity fires — rapid transactions far above baseline interval',
      'Behavioral risk score exceeds threshold — velocity anomaly triggered',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Contract Diversity fires — unknown contract detected',
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Function Pattern fires — near-maximum mint cap utilization in single action',
      'Behavioral risk score exceeds threshold — suspicious near-limit exploitation',
  ...
  },
  {
    ...
    narrative:
      'The most insidious attack: the compromised agent doesn\'t spike — it drifts. Starting at 0.1 ETH per trade, it gradually increases each transaction. After many trades, the rolling average has shifted dramatically — an increase that never triggered Sequential Probing because the early steps were flat. SentinelCRE\'s Cumulative Drift dimension compares the current value against the frozen origin baseline and catches the slow poisoning across multiple behavioral dimensions.',
    ...
    steps: [
      ...
      'Layer 2: Cumulative Drift fires — current value far above frozen origin baseline',
      'Layer 2: Velocity fires — rapid transactions in succession',
      'Layer 2: Value Deviation fires — significantly above moving average',
      'Behavioral risk score exceeds threshold — slow baseline poisoning detected and blocked',
    ],
    proposal: {
      agentId: DEMO_AGENTS[0].id,
      targetContract: APPROVED_DEX,
...
export const INCIDENT_SCENARIOS: DemoScenario[] = [
  {
    ...
    steps: [
      ...
      'Layer 1: PolicyLib passes — value, target, function all within bounds',
      'Layer 2: Time-of-Day anomaly fires — activity outside normal operating hours',
      'Layer 2: Social engineering patterns detected — urgency language + fund extraction',
      'Behavioral risk score exceeds threshold — this is exactly what happened to AIXBT on Base',
    ],
    proposal: {
      agentId: DEMO_AGENTS[0].id,
      targetContract: APPROVED_DEX,
  ...
  },
  {
    ...
    steps: [
      ...
      'Layer 2: Sequential Probing fires — monotonically increasing values detected',
      'Layer 2: Value Deviation fires — significantly above moving average',
      'Layer 2: Cumulative Drift fires — far above frozen origin baseline',
      'Behavioral risk score exceeds threshold — caught probing before reaching actual limit',
    ],
    proposal: {
      agentId: DEMO_AGENTS[0].id,
      targetContract: APPROVED_DEX,
