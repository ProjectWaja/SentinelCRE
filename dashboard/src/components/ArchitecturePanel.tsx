...
const AI_AGENT_INCIDENTS = [
  {
    ...
    prevention: 'Behavioral engine detects social engineering patterns and fund extraction language across multiple risk dimensions. Risk score exceeds threshold, triggering DENY — exactly the off-hours drain SentinelCRE was built to stop.',
    caughtBy: ['L2'] as ('L1' | 'L2' | 'L3')[],
    stoppedAt: 'Behavioral Risk Scoring',
  },
  {
  ...
  },
  {
    ...
    prevention: 'Sequential Probing detection catches the binary-search doubling pattern. Cumulative Drift flags deviation from origin baseline. Value Deviation confirms anomalous amounts. Risk score exceeds threshold, triggering DENY — and Confidential Compute means the agent can\'t even see the thresholds it\'s probing for.',
    caughtBy: ['L2'] as ('L1' | 'L2' | 'L3')[],
    stoppedAt: 'Behavioral Risk Scoring',
  },
  {
